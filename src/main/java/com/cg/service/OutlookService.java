...
public class OutlookService {
	...
	public void unsubscribeFromOutlookService(CalendarSyncToken calendarSyncToken) {
		...
		if (refreshTokenResponse != null) {
			try {
				...
				httpService.deleteRequest(url, accessToken);
	...
	public Map<String, Object> renewOutlookService(CalendarSyncToken calendarSyncToken) {
		
		Map<String, Object> response = new HashMap<>();
		//Android
		//String url = "https://graph.microsoft.com/v1.0/subscriptions/{id}";

		//Outlook URl
		String apiUrl = "https://outlook.office.com/api/v2.0/me/subscriptions/"+calendarSyncToken.getSubscriptionId()+"";
		JSONObject refreshTokenResponse = getAccessTokenFromRefreshToken(calendarSyncToken.getRefreshToken());
		if (refreshTokenResponse != null) {
			try {
				Calendar cal = Calendar.getInstance();
				...
				JSONObject postData = new JSONObject();
				postData.put("@odata.type", "#Microsoft.OutlookServices.PushSubscription");
				postData.put("SubscriptionExpirationDateTime", ""+future3rdDay+"");
	...
	/*public static void main(String[] args) {
		OutlookService os = new OutlookService();
		String refreshToken = "MCQSO!FeFypkHujmdYvAotMgP1DLiOoLX6KjilHuJTCZmygcU1P9FNNY5yB7gUwGD34gmVkCbSolJUGmNC8C9m1rbzd1qw2LvErzPNqH6cZIDysB4REzg094pAmXYyroHDpIvgQ7QlHn3TeqF!6lTJOuDbeU*tOzYo9N2y18XuPfHm0M7u7H4b6sLfXAoEZ7QqZu00of2Ip72iIA49g48t7jVESAXXgEggmdUVjwT4yvxdDUMEX6qiUy3i8h3xowjuaOpfxKT4ndF1WaioxNAVqaVSlglGeIwbpA6H5XFJgh4bKX6LSk!TfhwJxpMXFEWQ7sMDtg3EdLWN3LnlenEbgq!guLE*NRAN9JVM5T4l!mUsvOyugg4I4O9kK8rNNY9cweXLdSXBtAwjg1efNECnJ*iINtwrQlN5Zyk4JGA7LNpihnHOThw48bvNTXyw39nZY9fBCDUZsD6OQHLNuIpOqNorYk3g2183e2ojiz*CDpZ";
